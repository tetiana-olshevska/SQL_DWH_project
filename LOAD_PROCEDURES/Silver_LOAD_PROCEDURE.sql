/*
===============================================================================
Stored Procedure: Load Silver Layer (Bronze schema tables -> Silver schema tables)
===============================================================================
This stored procedure performs the ETL process to populate the Silver schema tables from the Bronze schema.
It first truncates tables and then inserts transformed and cleansed data.
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT CASE WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid, 4, LEN(cid)) -- Remove 'NAS' prefix if present
               ...
               CASE WHEN UPPER(TRIM(gen)) = 'FEMALE' THEN 'F'
